                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="inputunit1" id="inputunit1">
                            <option id="c" value="Celcius" <?php if(isset($unit1)){if($unit1 == 'Celcius') echo "selected";} ?>>Celcius</option>
                            <option id="fh" value="Fahrenheit" <?php if(isset($unit2)){if($unit1 == 'Fahrenheit') echo "selected";} ?>>Fahrenheit</option>
                            <option id="k" value="Kelvin" <?php if(isset($unit2)){if($unit1 == 'Kelvin') echo "selected";} ?>>Kelvin</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="inputunit2" id="inputunit2">
                            <option id="c1" value="Celcius" <?php if(isset($unit2)){if($unit2 == 'Celcius') echo "selected";} ?>>Celcius</option>
                            <option id="fh1" value="Fahrenheit" <?php if(isset($unit2)){if($unit2 == 'Fahrenheit') echo "selected";} ?>>Fahrenheit</option>
                            <option id="k1" value="Kelvin" <?php if(isset($unit2)){if($unit2 == 'Kelvin') echo "selected";} ?>>Kelvin</option>
